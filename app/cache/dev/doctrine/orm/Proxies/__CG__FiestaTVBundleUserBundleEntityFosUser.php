...
namespace Proxies\__CG__\FiestaTV\Bundle\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class FosUser extends \FiestaTV\Bundle\UserBundle\Entity\FosUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'profilePictureFile', '' . "\0" . 'FiestaTV\\Bundle\\UserBundle\\Entity\\FosUser' . "\0" . 'tempProfilePicturePath', 'profilePicturePath', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
