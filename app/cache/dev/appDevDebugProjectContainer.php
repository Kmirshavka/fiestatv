...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'fiestatv.mysql.eu1.frbit.com', 'port' => 3306, 'dbname' => 'fiestatv', 'user' => 'fiestatv', 'password' => 'sd67thwQ-f4nLXzV9LEXU4SX', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/FiestaTV/Bundle/MainWebSiteBundle/Resources/config/doctrine') => 'FiestaTV\\Bundle\\MainWebSiteBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'FiestaTV\\Bundle\\MainWebSiteBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/FiestaTV/Bundle/UserBundle/Entity'))), 'FiestaTV\\Bundle\\UserBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('FiestaTVMainWebSiteBundle' => 'FiestaTV\\Bundle\\MainWebSiteBundle\\Entity', 'UserBundle' => 'FiestaTV\\Bundle\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_999e897bf1cfd2612846f3045c955389bbc6068aab2e234d53d779b94b5001ba');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FiestaTV\\Bundle\\UserBundle\\Entity\\FosUser');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FiestaTV\\Bundle\\UserBundle\\Entity\\FosUser');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FiestaTV\\Bundle\\UserBundle\\Entity\\FosUser');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FiestaTV\\Bundle\\UserBundle\\Entity\\FosUser');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'FiestaTV\\Bundle\\UserBundle\\Entity\\FosUser');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/FiestaTV/Bundle/MainWebSiteBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/FiestaTV/Bundle/MainWebSiteBundle/Resources/views'), 'FiestaTVMainWebSite');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/FiestaTV/Bundle/UserBundle/Resources/views'), 'User');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FiestaTVMainWebSiteBundle' => 'FiestaTV\\Bundle\\MainWebSiteBundle\\FiestaTVMainWebSiteBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'UserBundle' => 'FiestaTV\\Bundle\\UserBundle\\UserBundle',
            ...
            'database_host' => 'fiestatv.mysql.eu1.frbit.com',
            'database_port' => 3306,
            'database_name' => 'fiestatv',
            'database_user' => 'fiestatv',
            'database_password' => 'sd67thwQ-f4nLXzV9LEXU4SX',
            ...
            'fos_user.model.user.class' => 'FiestaTV\\Bundle\\UserBundle\\Entity\\FosUser',
